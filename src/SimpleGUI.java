...
public class SimpleGUI extends JFrame implements ActionListener, ItemListener, ChangeListener {
    ...
    private void init() {
        ...
        boldCheckBox.setBounds(100,100,50,50);
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (source instanceof JButton) {
            ...
            if (text.equals("Send")) {
                ...
                JFrame miniFrame = new JFrame("Little Frame");
                miniFrame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
                miniFrame.setSize(150,150);
                miniFrame.setLocation(200,200);
                JLabel label1 = new JLabel("Hello");
                JPanel panel1 = new JPanel();
                panel1.add(label1);
                miniFrame.add(panel1, BorderLayout.NORTH);
                miniFrame.setVisible(true);
            }
        } else if (source instanceof JMenuItem){
            JMenuItem menuItemX = (JMenuItem) source;
            String text = menuItemX.getText();
    ...
    public void itemStateChanged(ItemEvent e) {
        ...
        if (checkBoxOnOrOff == 1) {
            ...
            if (cbText.equals("Bold")){
                textArea.setFont(temp.deriveFont(temp.getStyle() | Font.BOLD));
            }
